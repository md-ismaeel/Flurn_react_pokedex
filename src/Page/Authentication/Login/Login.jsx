...
import { setIsLogin, setUser } from "../../../Redux/Slice/PokemonSlice";
import { Loader } from "../../../Components/Loader";
import { FaEye } from "react-icons/fa";
import { FaEyeSlash } from "react-icons/fa";

export default function Login() {
    const { user, isLogin } = useSelector((state) => state?.pokeDex);
            ...
            <div className="w-full min-h-screen flex justify-center items-center">
                ...
                >
                    ...
                    <span
                        ...
                        className="eyes absolute bottom-[11.2rem] right-16 text-xl text-slate-600 cursor-pointer"
                    >
                    ...
                    <button
                        ...
                        className={cssClass.forgetBtnCss}
                    >
                        Forget password?
                    </button>
