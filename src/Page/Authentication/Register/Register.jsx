    ...
    <section className="w-full h-auto flex justify-center items-center">
      <div className="w-full min-h-screen flex justify-center items-center">
        <form
          ...
          className={`relative ${cssClass.registerFormCss}`}
        >
          ...
          <span
            ...
            className="eyes-1 absolute bottom-[10.4rem] right-[5rem] text-xl text-slate-600 cursor-pointer"
          >
          ...
          <button
            type="submit"
            className={`relative ${cssClass.buttonCss} ${
