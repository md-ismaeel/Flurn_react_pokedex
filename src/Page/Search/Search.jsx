...
export default function Search() {
    ...
    return (
        <section className="w-full h-auto flex flex-col justify-center items-center">
            <span className="search-sec w-1/2 mt-10 flex justify-start items-center gap-2">
                <FaArrowLeftLong
                    onClick={() => navigate("/")}
                    className="text-yellow-500 hover:text-yellow-600 text-4xl cursor-pointer font-semibold"
                />
                <span className="text-2xl font-semibold">Search Pokédex</span>
                {/* <span className="text-2xl font-semibold">Search Character</span> */}
            </span>
            <form
