...
export default function BaseStats({ stats }) {
    ...
    return (
        <div className='baseState-sec w-[80%] flex flex-col justify-center items-center max-w-md mx-auto p-6 mt-4 mb-4'>
            {stats && stats.map((st, i) => (
                <div key={i} className='states-box mb-2 flex justify-center items-center gap-4 w-full'>
                    <div className='states-name flex justify-between items-center mb-2 w-[40%]'>
                    ...
                    <div className='progress-bar relative w-[45%] flex bg-gray-200 rounded-full h-[4px] mt-[-7px]'>
                        <div
